...
namespace KT.Infrastructure.Migrations
{
    ...
    [Migration("20240509171852_InitialCreate")]
            ...
            modelBuilder.Entity("KT.Domain.CourseTemplateAggregate.CourseTemplate", b =>
                {
                    ...
                    b.OwnsMany("KT.Domain.CourseTemplateAggregate.Entities.ModuleTemplate", "ModuleTemplates", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.Property<string>("CriteriaTemplates")
                                .IsRequired()
                                .HasColumnType("nvarchar(max)");
                            ...
                            b1.ToTable("ModuleTemplates", "CourseTemplate");
