...
namespace KT.Infrastructure.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CourseTemplateModuleTemplates",
                schema: "CourseTemplate",
                columns: table => new
                {
                    CourseTemplateId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ModuleTemplateId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseTemplateModuleTemplates", x => new { x.CourseTemplateId, x.ModuleTemplateId });
                    table.ForeignKey(
                        name: "FK_CourseTemplateModuleTemplates_CourseTemplates_ModuleTemplateId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseTemplateModuleTemplates_ModuleTemplateId",
                schema: "CourseTemplate",
                table: "CourseTemplateModuleTemplates",
