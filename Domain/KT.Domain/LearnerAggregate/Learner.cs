...
public class Learner : AggregateRoot
{
    ...
    /// </summary>
    private Learner(Guid id, string forename, string surname, DateOnly dateOfBirth, Address address,
...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
    ...
    /// </summary>
    public static Learner Create(string forename, string surname, DateOnly dateOfBirth, Address address,
        ContactDetails contactDetails)
    {
