...
public class SessionTemplate : Entity
{
    ...
    private SessionTemplate(
        Guid id, Guid sessionPlanTemplateId, SessionType sessionType, Guid? cohortId, string location, string notes,
        string meetingLink, ScheduleDetails scheduleDetails)
        : base(id)
    {
...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
    ...
    public static SessionTemplate Create(
        Guid sessionPlanTemplateId, SessionType sessionType, Guid? cohortId, string location, string notes,
        string meetingLink,
        int startWeek, DayOfWeek dayOfWeek, TimeOnly startTime, TimeSpan expectedDuration)
    {
        ...
        var sessionTemplate = new SessionTemplate(
            Guid.NewGuid(), sessionPlanTemplateId, sessionType, cohortId, location, notes, meetingLink,
            scheduleDetails);
