...
public class ActivityTemplate : Entity
{
    ...
    private ActivityTemplate(
        Guid id, Guid activityPlanTemplateId, string title, string description, List<Guid> documentIds,
...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
    ...
    /// <summary>
    ///     The description of the activity template. E.g., "A booklet covering an introduction to software development
    ///     concepts."
    /// </summary>
    ...
    public static ActivityTemplate Create(
        Guid activityPlanTemplateId, string title, string description, List<Guid> documentIds,
        List<Guid> moduleTemplateIds,
        int startWeek, DayOfWeek dayOfWeek, TimeOnly startTime, TimeSpan expectedDuration)
    {
        ...
        var activityTemplate = new ActivityTemplate(
            Guid.NewGuid(), activityPlanTemplateId, title, description, documentIds, moduleTemplateIds,
            scheduleDetails);
    ...
    /// </summary>
    public ScheduleDetails ChangeScheduleDetails(int startWeek, DayOfWeek dayOfWeek, TimeOnly startTime,
