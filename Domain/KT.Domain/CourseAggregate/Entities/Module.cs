...
public class Module : Entity
{
    ...
    /// </summary>
    private Module(Guid id, Guid courseId, string code, string title, string description, int level,
...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
    ...
    public static Module Create(
        Guid courseId, string code, string title, string description, int level,
        AwardingOrganisation awardingOrganisation)
    {
    ...
    {
        _ = _criteria.FirstOrDefault(x => x.Equals(criteria))
