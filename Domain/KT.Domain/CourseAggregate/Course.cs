...
public class Course : AggregateRoot
{
    ...
    /// </summary>
    private Course(Guid id, Guid learnerId, string code, string title, string description, int level,
...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
    ...
    /// </summary>
    public static Course Create(Guid learnerId, string code, string title, string description, int level,
        DateTime startDate, DateTime expectedEndDate, DateTime? actualEndDate)
    {
        var course = new Course(Guid.NewGuid(), learnerId, code, title, description, level, startDate, expectedEndDate,
            actualEndDate);
    ...
    /// </summary>
    public Module AddModule(string title, string code, string description, int level,
